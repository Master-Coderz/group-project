...
module.exports = {
  ...
  hasStarredIn: function(actor, movie) {
    return actor + " has starred in " + movie;
  },
  movieYear: function(year) {
    return "this movie came out " +(2018-year)+ " years ago!";
  },
  annualEarningsAverage: function(actor, totalEarnings, yearsActive) {
    return actor + " has earned " + (totalEarnings / yearsActive) + " a year!";
  }
}
